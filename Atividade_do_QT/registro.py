...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.input_endereco.setPlaceholderText(QCoreApplication.translate("Form", u"Insira seu endere\u00e7o", None))
        ...
        self.input_tefefone.setText("")
        self.input_tefefone.setPlaceholderText(QCoreApplication.translate("Form", u"Insira seu telefone", None))
        self.input_nome.setText("")
        self.input_nome.setPlaceholderText(QCoreApplication.translate("Form", u"Insira seu nome", None))
